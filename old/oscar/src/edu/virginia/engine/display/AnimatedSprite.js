...
class AnimatedSprite extends Sprite{
	...
	constructor(id, filename){
		super(id, filename);
		this.currSprite = -1; //-1 is idle image
		this.spriteLimit = 10; //how many animations in a cycle
	...
	/* Getters and Setters */
	setSpriteX(spriteX){this.spriteX = spriteX;}
	setSpriteY(spriteY){this.spriteY = spriteY;}
	/* Update for scaling */
