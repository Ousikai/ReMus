...
public class TempleOfTime extends Game{
	...
	public void setupPlatformsAndNotes(){
		...
		notesCollection.addChild(new Sprite ("d4", "d.png", 700, 250));
		notesCollection.addChild(new Sprite ("a4", "a.png", 200, -100));
		notesCollection.addChild(new Sprite ("g4", "g.png", 800, -300));
		notesCollection.addChild(new Sprite ("e4", "e.png", 800, -750));
		notesCollection.addChild(new Sprite ("f4", "f.png", 700, -1300));
	}
