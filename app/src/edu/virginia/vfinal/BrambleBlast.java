...
public class BrambleBlast extends Game{
	...
	int foregroundFallRate = 10; //how often platforms should move
...
//			/* Draw all assets */
	...
	public void setupBackgrounds(){
		// Level 0
		backgroundFilePaths.add("BrambleBlastLevel0.jpg");
		// Level 1
		backgroundFilePaths.add("BrambleBlastLevel1.jpg");
		// Level 2
		backgroundFilePaths.add("BrambleBlastLevel2.jpg");
		// Level 3
		backgroundFilePaths.add("BrambleBlastLevel3.jpg");
		// Level 4
		backgroundFilePaths.add("BrambleBlastLevel4.jpg");
		// Level 5
		...
		// Current Background
		backgroundCollection.addChild(new Sprite ("Current Background", "BrambleBlastLevel0.jpg", -200, -400));
	}
	...
	public void setupAudio() throws IOException{
		...
		soundManager.LoadBGM(0, "BrambleBlastLevel0.wav");
		soundManager.LoadBGM(1, "BrambleBlastLevel1.wav");
		soundManager.LoadBGM(2, "BrambleBlastLevel2.wav");
		soundManager.LoadBGM(3, "BrambleBlastLevel3.wav");
		soundManager.LoadBGM(4, "BrambleBlastLevel4.wav");
