...
public class BaseGame extends Game{
	...
	public void draw(Graphics g){
		...
		String strNotesCollected = "Notes Collected: " + notesCollected + "/" + 15;
...
//		}
	...
	public void setupBackgrounds(){
		// Level 0
		backgroundFilePaths.add("EreveLevel0.jpg");
		// Level 1
		backgroundFilePaths.add("EreveLevel1.jpg");
		// Level 2
		backgroundFilePaths.add("EreveLevel2.jpg");
		// Level 3
		backgroundFilePaths.add("EreveLevel3.jpg");
		// Level 4
		backgroundFilePaths.add("EreveLevel4.jpg");
		// Level 5
		backgroundFilePaths.add("EreveLevel5.jpg");
		// Previous Background
		//backgroundCollection.addChild(new Sprite ("Previous Background", "EreveLevel0.jpg", 0, -332));
		// Current Background
		backgroundCollection.addChild(new Sprite ("Current Background", "EreveLevel0.jpg", 0, -332));
	}
	...
	public void setupAudio() throws IOException{
		...
		soundManager.LoadBGM(0, "EreveLevel0.wav");
		soundManager.LoadBGM(1, "EreveLevel1.wav");
		soundManager.LoadBGM(2, "EreveLevel2.wav");
		soundManager.LoadBGM(3, "EreveLevel3.wav");
		soundManager.LoadBGM(4, "EreveLevel4.wav");
		soundManager.LoadBGM(5, "EreveLevel5.wav");
